...
const ru: Dict = {
  ...
  'bar.play': '▶️ Играть уровень #{n}',
  'bar.mode': 'Режим:',
  'bar.easy': '🌱 Лёгкое',
  'bar.brave': '🔥 Смелое',
  'bar.super': '⭐ Супер',
  'bar.invite': '👥 Пригласить друзей',
  'bar.level': 'Уровень {n}',
...
const kk: Dict = {
  ...
  'bar.play': '▶️ #{n}-деңгейді ойнау',
  'bar.mode': 'Режим:',
  'bar.easy': '🌱 Жеңіл',
  'bar.brave': '🔥 Батыл',
  'bar.super': '⭐ Супер',
  'bar.invite': '👥 Достарды шақыру',
  'bar.level': 'Деңгей {n}',
