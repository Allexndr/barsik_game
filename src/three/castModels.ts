...
export const CAST_CHAR_GLB: Record<string, string> = {
  ...
  deer: 's1_kit_deer.glb',
  beaver: 's1_kit_beaver.glb',
  penguin: 's1_kit_penguin.glb',
  bee: 's1_kit_bee.glb',
  polar: 's1_kit_polar.glb',
  chick: 's1_kit_chick.glb',
  kit_cat: 's1_kit_cat.glb',
};
...
export const CAST_PROP_GLB: Record<string, string> = {
  ...
  bench: 's1_kit_bench.glb',
  campfire: 's1_kit_campfire.glb',
  snow_pile: 's1_kit_snow_pile.glb',
  tree_decorated: 's1_kit_tree_decorated.glb',
  present: 's1_kit_present.glb',
  present_b: 's1_kit_present_b.glb',
  winter_hat: 's1_kit_winter_hat.glb',
  scarf: 's1_gen_scarf.glb',
  strawberry: 's1_kit_strawberry.glb',
  cake: 's1_kit_cake.glb',
  honey: 's1_kit_honey.glb',
  star: 's1_kit_star.glb',
  flag: 's1_kit_flag.glb',
  bridge_mini: 's1_kit_bridge_mini.glb',
  tent: 's1_kit_tent.glb',
  berry: 's1_gen_berry.glb',
  mushroom: 's1_gen_mushroom.glb',
  lantern_wood: 's1_kit_lantern_wood.glb',
  lantern_hang: 's1_kit_lantern_hang.glb',
  apple_kit: 's1_kit_apple.glb',
  flowers: 's1_kit_flowers.glb',
  flowers_tall: 's1_kit_flowers_tall.glb',
