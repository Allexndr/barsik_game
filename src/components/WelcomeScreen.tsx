      ...
      <main>
        <section className="welcome-hero" id="top">
          <ResponsivePicture
            ...
            alt=""
            sources={[
              { media: '(min-width: 760px)', src: '/assets/landing/landing_hero_desktop.webp?v=20260824' },
              { media: '(orientation: landscape)', src: '/assets/landing/landing_hero_desktop.webp?v=20260824' },
            ]}
            fallbackSrc="/assets/landing/landing_hero_mobile.webp?v=20260824"
          />
