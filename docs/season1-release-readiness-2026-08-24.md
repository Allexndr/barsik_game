...
1. Run the missing full mobile golden routes for Levels 1–4, 6 and 8–10. Do not
...
candidate. Gold-master status waits on the eight incomplete mobile routes, one
