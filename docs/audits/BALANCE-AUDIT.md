...
## Перепроверка сложности — 2026-09-12

Последние жалобы на «слишком сложно» разделены на три класса: непонятная цель, узкое окно
реакции и ограничение тестового маршрута. Подтверждённые изменения внесены в L0, L2, L3 и L4.
Снижать количество механик во всём сезоне не требуется: L2 соответствует ТЗ (шесть яблок),
а L6/L7/L11/L15 требуют наблюдения детей, чтобы не сломать смысл задач автоматическим
упрощением.

| Проверка | Результат |
|---|---|
| Все 17 уровней стартуют и выходят из intro | 17/17 в четырёх чистых блоках |
| Самые рискованные для ребёнка зоны | L6 чтение загадок, L7 понимание медленного шага, L11 ловля, L15 таймер |
| Что не доказано | completion time на живых детях, реальный FPS/звук, production parity |
| Следующий критерий | ни один ребёнок 10–14 не должен бросать уровень без понятной причины; собрать время, ошибки и место остановки |
